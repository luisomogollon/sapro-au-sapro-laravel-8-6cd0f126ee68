...
class FillPermissionsForLingote extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLingote constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lingote',
            'admin.lingote.index',
            'admin.lingote.create',
            'admin.lingote.show',
            'admin.lingote.edit',
            'admin.lingote.delete',
            'admin.lingote.bulk-delete',
        ]);
