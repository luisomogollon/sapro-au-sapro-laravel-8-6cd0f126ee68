...
class FillPermissionsForLingoteEstado extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLingoteEstado constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lingote-estado',
            'admin.lingote-estado.index',
            'admin.lingote-estado.create',
            'admin.lingote-estado.show',
            'admin.lingote-estado.edit',
            'admin.lingote-estado.delete',
            'admin.lingote-estado.bulk-delete',
        ]);
