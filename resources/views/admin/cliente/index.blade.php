                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'cliente_correo'">{{ trans('admin.cliente.columns.cliente_correo') }}</th>
                                        <th is='sortable' :column="'cliente_nombre'">{{ trans('admin.cliente.columns.cliente_nombre') }}</th>
                                        <th is='sortable' :column="'cliente_rif'">{{ trans('admin.cliente.columns.cliente_rif') }}</th>
                                        <th is='sortable' :column="'cliente_telf'">{{ trans('admin.cliente.columns.cliente_telf') }}</th>
                                        <th is='sortable' :column="'cliente_tipo'">{{ trans('admin.cliente.columns.cliente_tipo') }}</th>
                                        {{--<th is='sortable' :column="'comision_id'">{{ trans('admin.cliente.columns.comision_id') }}</th>--}}
                                        ...
                                        {{--<th is='sortable' :column="'presentacion_id'">{{ trans('admin.cliente.columns.presentacion_id') }}</th>--}}
                                        {{--<th is='sortable' :column="'user_id'">{{ trans('admin.cliente.columns.user_id') }}</th>--}}
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.cliente_correo }}</td>
                                        ...
                                        <td>@{{ item.cliente_rif }}</td>
                                        <td>@{{ item.cliente_telf }}</td>
