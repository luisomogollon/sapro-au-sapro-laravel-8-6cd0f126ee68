...
class FillPermissionsForMovimiento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMovimiento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.movimiento.create',
            'admin.movimiento.show',
            'admin.movimiento.edit',
            'admin.movimiento.delete',
            'admin.movimiento.bulk-delete',
        ]);
