...
class FillPermissionsForPresentacione extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPresentacione constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.presentacione',
            'admin.presentacione.index',
            'admin.presentacione.create',
            'admin.presentacione.show',
            'admin.presentacione.edit',
            'admin.presentacione.delete',
            'admin.presentacione.bulk-delete',
        ]);
