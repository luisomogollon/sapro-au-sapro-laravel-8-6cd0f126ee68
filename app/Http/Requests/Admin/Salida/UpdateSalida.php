...
class UpdateSalida extends FormRequest
{
    /**
    ...
    {
        return Gate::allows('admin.salida.edit', $this->salida);
    }
    ...
    {
        return [
            //'salida_referencia' => ['nullable', Rule::unique('salidas', 'salida_referencia')->ignore($this->salida->getKey(), $this->salida->getKeyName()), 'string'],
