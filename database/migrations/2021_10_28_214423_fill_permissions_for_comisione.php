...
class FillPermissionsForComisione extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComisione constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.comisione',
            'admin.comisione.index',
            'admin.comisione.create',
            'admin.comisione.show',
            'admin.comisione.edit',
            'admin.comisione.delete',
            'admin.comisione.bulk-delete',
        ]);
