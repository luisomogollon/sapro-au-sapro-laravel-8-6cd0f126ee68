...
class FillPermissionsForColectore extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForColectore constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.colectore',
            'admin.colectore.index',
            'admin.colectore.create',
            'admin.colectore.show',
            'admin.colectore.edit',
            'admin.colectore.delete',
            'admin.colectore.bulk-delete',
        ]);
