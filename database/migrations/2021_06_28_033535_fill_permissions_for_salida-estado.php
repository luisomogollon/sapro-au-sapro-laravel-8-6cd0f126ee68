...
class FillPermissionsForSalidaEstado extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSalidaEstado constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.salida-estado',
            'admin.salida-estado.index',
            'admin.salida-estado.create',
            'admin.salida-estado.show',
            'admin.salida-estado.edit',
            'admin.salida-estado.delete',
            'admin.salida-estado.bulk-delete',
        ]);
